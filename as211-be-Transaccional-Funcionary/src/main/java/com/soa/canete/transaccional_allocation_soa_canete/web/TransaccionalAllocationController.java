...
public class TransaccionalAllocationController {
    ...
    @PostMapping("/asignametTutor")
    public Mono<TransaccionalAllocationResponseDto> saveNewAsignamentTutor(@RequestBody TransaccionalAllocationRequestDto dto) {
        return this.transaccionalAllocationService.saveNewAsignamentTutor(dto);
    }
}
